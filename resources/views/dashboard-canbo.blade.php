...
<div class="row">
                ...
                <div class="small-box bg-purple">
                    <div class="inner">
                        ...
                        <div class="hidden-xs div_nn">
                            <p class="div_nn_p"><span class="div_nn_p_span">{{ $nganhnghe['slNganhNghe_TrungCap'] }}</span> Trung cấp </p>
                            <p class="div_nn_p"> <span class="div_nn_p_span">{{ $nganhnghe['slNganhNghe_CaoDang'] }}</span> Cao đẳng</p>
                        </div>
                    </div>
                    <!-- icon (Phong)-->
                    <div class="icon"><i class="fas fa-screwdriver-wrench" style="color: white;"></i></div>
        ...
        <div class="col-lg-6 col-xs-6">
            <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    <div class="hidden-xs div_kdt"  class="display: flex;">
                                ...
                                <div class="">
                                    @foreach ($khoadaotaocaodangQuery as $caodang)
                                        <p class="div_kdt_div1_1_p">
                                            <a href="http://localhost/cea-2.0/public/khoa-dao-tao/{{ $caodang->kdt_id }}/hoc-ky">{{ $caodang->kdt_ten }}</a>
                                        </p>
                                    @endforeach
                                </div>
                        </div>
                ...
                <div class="icon"><i class="fa-solid fa-gears" style="color: white;"></i></div>
                    ...
                    <div class="inner">
                        ...
                        <div class="hidden-xs div_lh">
                            ...
                            <span class="div_lh_span2">
                                ...
                                @endphp
                                <div class="div_lh_span_div_chart" style=" height: {{$heightPercentage}}% ;">
                                    <span class="div_lh_span_div_chart_span">{{$lophocs[0]['sllop']}} </span>
                                </div>
                            ...
                            <span style="width: calc(100% / 5); flex: 1; position: relative;">
                                ...
                                @endphp
                                <div class="div_lh_span_div_chart" style=" height: {{$heightPercentage}}% ;">
                                    <span class="div_lh_span_div_chart_span">{{$lophocs[1]['sllop']}}</span>
                                </div>
                            ...
                            <span style="width: calc(100% / 5); flex: 1; position: relative;">
                                ...
                                @endphp
                                <div class="div_lh_span_div_chart" style=" height: {{$heightPercentage}}% ;">
                                    <span class="div_lh_span_div_chart_span">{{$lophocs[2]['sllop']}} </span>
                                </div>
                            ...
                            <span style="width: calc(100% / 5); flex: 1; position: relative;">
                                ...
                                @endphp
                                <div class="div_lh_span_div_chart" style=" height: {{$heightPercentage}}% ;">
                                    <span class="div_lh_span_div_chart_span">{{$lophocs[3]['sllop']}} </span>
                                </div>
                            ...
                            <span style="width: calc(100% / 5); flex: 1; position: relative;">
                                ...
                                @endphp
                                <div class="div_lh_span_div_chart" style=" height: {{$heightPercentage}}% ;">
                                    <span class="div_lh_span_div_chart_span">{{$lophocs[4]['sllop']}} </span>
                                </div>
            ...
            <div class="small-box bg-olive">
                <div class="inner">
                    ...
                    <div style="width: 100%;display: flex; justify-content: center; margin-bottom: 26px;">
                        <div style="display: flex; justify-content: left; margin-bottom: 5px; margin-right: 10px; "> 
                            <div style="margin-right: 5px;  width: 20px; height: 20px; background: red;"></div> - đợt thi </div>
                        <div style="display: flex; justify-content: left; margin-bottom: 5px;">
                            <div style=" margin-right: 5px; width: 20px; height: 20px; background: #00ff29;"></div> - xét tốt nghiệp</div>
                    </div>
                    <div class="hidden-xs" style="border: 1px solid white; height: 130px; width: 70%; margin-left: 28px; border-right: none; border-top: none; margin-top: -5px; display: flex; margin-bottom: 19px;">
                        ...
                        <span style="width: calc(100% / 5); flex: 1;    position: relative;">
                            ...
                            @endphp
                            <div style=" width: 40%; height: {{$heightPercentage}}% ; background: red;  position: absolute; bottom: 0; left: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsDotThi['value5nam'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 4]}} </span>
                            </div>
                            <div style=" width: 40%; height: {{$heightPercentage}}% ; background: #00ff29;  position: absolute; bottom: 0; right: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsdotxettotnghiep['value5namtotnghiep'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 4]}} </span>
                            </div>
                            <span style=" position: absolute; bottom:-22px; right: 27px; font-size: 13px;">{{$dsdotxettotnghiep['maxnamxettotnghiep'] - 4}}</span>
                        </span>
                        <span style="width: calc(100% / 5); flex: 1; position: relative;">
                            @php
                            ...
                            @endphp
                            <div style=" width: 40%; height: {{$heightPercentage3}}% ; background: red;  position: absolute; bottom: 0; left: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsDotThi['value5nam'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 3]}} </span>
                            </div>
                            <div style=" width: 40%; height: {{$heightPercentage31}}% ; background: #00ff29;  position: absolute; bottom: 0; right: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsdotxettotnghiep['value5namtotnghiep'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 3]}} </span>
                            </div>
                            <span style="  position: absolute;  bottom: -22px;  right: 27px; font-size: 13px;">{{$dsdotxettotnghiep['maxnamxettotnghiep'] - 3}}</span>
                        </span>
                        <span style="width: calc(100% / 5); flex: 1; position: relative;">
                            @php
                            ...
                            @endphp
                            <div style=" width: 40%; height: {{$heightPercentage2}}% ; background: red;  position: absolute; bottom: 0; left: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsDotThi['value5nam'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 2]}} </span>
                            </div>
                            <div style=" width: 40%; height: {{$heightPercentage21}}% ; background: #00ff29;  position: absolute; bottom: 0; right: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsdotxettotnghiep['value5namtotnghiep'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 2]}} </span>
                            </div>
                            <span style="position: absolute; bottom: -22px; right: 27px; font-size: 13px;">{{$dsdotxettotnghiep['maxnamxettotnghiep'] - 2}}</span>
                        </span>
                        <span style="width: calc(100% / 5); flex: 1; position: relative;">
                            @php
                            ...
                            @endphp
                            <div style=" width: 40%; height: {{$heightPercentage1}}% ; background: red;  position: absolute; bottom: 0; left: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsDotThi['value5nam'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 1]}} </span>
                            </div>
                            <div style=" width: 40%; height: {{$heightPercentage12}}% ; background: #00ff29;  position: absolute; bottom: 0; right: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsdotxettotnghiep['value5namtotnghiep'][$dsdotxettotnghiep['maxnamxettotnghiep'] - 1]}} </span>
                            </div>
                            <span style="position: absolute; bottom: -22px; right: 27px; font-size: 13px;">{{$dsdotxettotnghiep['maxnamxettotnghiep'] - 1}}</span>
                        </span>
                        <span style="width: calc(100% / 5); flex: 1; position: relative;">
                            @php
                            ...
                            @endphp
                            <div style=" width: 40%; height: {{$heightPercentage0}}% ; background: red;  position: absolute; bottom: 0; left: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsDotThi['value5nam'][$dsdotxettotnghiep['maxnamxettotnghiep']]}} </span>
                            </div>
                            <div style=" width: 40%; height: {{$heightPercentage01}}% ; background: #00ff29;  position: absolute; bottom: 0; right: 10%;">
                                <span class="div_lh_span_div_chart_span">{{$dsdotxettotnghiep['value5namtotnghiep'][$dsdotxettotnghiep['maxnamxettotnghiep']]}} </span>
                            </div>
                            <span style="position: absolute; bottom: -22px; right: 27px; font-size: 13px;">{{$dsdotxettotnghiep['maxnamxettotnghiep']}}</span>
                        </span>
                        <span style="position: absolute; right: 19%; bottom: 16%;">Năm</span>
                    </div>
                </div>
                <div class="icon"> <i class="fa fa-graduation-cap" style="color: white;"></i> </div>
                <a href="{{ route('lop-hoc.index') }}" class="small-box-footer">Chi tiết <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
     <!-- Số lượng sinh viên -->
     <div class="col-lg-12 col-xs-12 hidden-xs" >
            ...
            <p class="div_sv_p">Niên Khóa
                ...
                <div class="icon"><i class="fa fa-child" style="color: white;"></i> </div>
...
<div class="row">
    <div class="col-md-6">
            <a class="btn btn-block btn-social btn-twitter btn-lg"  href="{{ assetv('/TaiLieuHDSD_QuanLyDiemSinhVien_v2.doc') }}" target="_blank" download>  <i class="fa fa-download"></i> Tài liệu hướng dẫn </a>
        </div>
</div>
@endsection
@push('scripts')
