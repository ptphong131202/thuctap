...
const consumer = {
    save: function (formData) {
        return axios.post('http://localhost/cea_4.0/public/apimon-hoc/them-excel', formData);
    },
    uploadFile: function (file) {
        ...
        return axios.post('http://localhost/cea_4.0/public/apiexcel/import-mon-hoc', formData, headers);
    },
    getListHeDaoTao: function () {
        const url = 'http://localhost/cea_4.0/public/apihe-dao-tao/all';
        return axios.get(url).then(response => response.data);
    },
    getListNganhNghe: function () {
        const url = 'http://localhost/cea_4.0/public/apinganh-nghe/all';
        return axios.get(url).then(response => response.data);
    },
}
