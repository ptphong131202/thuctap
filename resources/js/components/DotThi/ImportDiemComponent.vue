...
const consumer = {
  ...
  saveBangDiem: function (formData) {
    const url = `http://localhost/cea_4.0/public/api/nhap-diem/${formData.lh_id}/bang-diem-dot-thi-loai0`;
    return axios.post(url, formData);
  },
  save: function (formData, dt_id) {
    return axios.post("http://localhost/cea_4.0/public/api/dot-thi/" + dt_id + "/nhap-diem-excel", formData);
  },
  uploadFile: function (file, lh_nienche) {
    ...
    return axios.post("http://localhost/cea_4.0/public/api/excel/import-diemdotthi", formData, headers);
  },
};
