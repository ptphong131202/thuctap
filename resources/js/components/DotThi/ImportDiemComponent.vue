...
const consumer = {
  ...
  getBangDiem: function (lh_id, mh_id, dt_id) {
    ...
    const url = `http://localhost/cea-4.0/public/api/nhap-diem/${lh_id}/bang-diem-dot-thi?mh_id=${mh_id}&dt_id=${dt_id}`;
    return axios.get(url).then((response) => response.data);
  },
  saveBangDiem: function (formData) {
    const url = `http://localhost/cea-4.0/public/api/nhap-diem/${formData.lh_id}/bang-diem-dot-thi-loai0`;
    return axios.post(url, formData);
  },
  save: function (formData, dt_id) {
    return axios.post("http://localhost/cea-4.0/public/api/dot-thi/" + dt_id + "/nhap-diem-excel", formData);
  },
  uploadFile: function (file, lh_nienche) {
    ...
    return axios.post("http://localhost/cea-4.0/public/api/excel/import-diemdotthi", formData, headers);
  },
};
