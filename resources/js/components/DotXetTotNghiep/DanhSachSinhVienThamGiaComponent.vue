...
import Label from '../../../../vendor/laravel/breeze/stubs/inertia-vue/resources/js/Components/Label.vue';
    ...
    const consumer = {
        getListSinhVien: function (dxtn_id) {
            const url = 'http://localhost/cea_4.0/public/api/dot-xet-tot-nghiep/'+dxtn_id+'/danhsachsinhvien'+ window.location.search;
        ...
        capNhatTrangThaiSinhVien: function (dxtn_id, dt_id, lh_id, sv_id, svd_ghichu, svxtn_vipham) {
            return axios.get('http://localhost/cea_4.0/public/api/dot-xet-tot-nghiep/'+dxtn_id+'/cap-nhat-trang-thai-sv-dxtn?dt_id='+ dt_id +'&lhid='+lh_id+'&svid='+sv_id+'&svxtn_ghichu=' + svd_ghichu + '&svxtn_vipham=' + svxtn_vipham );
        },
