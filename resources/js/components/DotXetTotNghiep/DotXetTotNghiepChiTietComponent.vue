...
import Label from '../../../../vendor/laravel/breeze/stubs/inertia-vue/resources/js/Components/Label.vue';
    ...
    const consumer = {
        getListLopHocTheoDotXetTotNghiep: function (dxtn_id) {
            const url = 'http://localhost/cea-4.0/public/api/lop-hoc/dot-xet-tot-nghiep-lop-hoc/'+dxtn_id+'/' + window.location.search;
        ...
        destroy: function (dxtn_id, lh_id, dt_id) {
            return axios.delete('http://localhost/cea-4.0/public/api/dot-xet-tot-nghiep/xoa-lop-du-xet/' + dxtn_id + '?lh_id=' + lh_id + '&dt_id=' + dt_id);
        },
