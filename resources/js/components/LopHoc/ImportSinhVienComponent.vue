...
<script>
    ...
    const consumer = {
        save: function (formData, lh_id) {
            return axios.post('http://localhost/tthl/public/apilop-hoc/'+lh_id+'/them-sinh-vien-excel', formData);
        },
        uploadFile: function (file) {
            ...
            return axios.post('http://localhost/tthl/public/apiexcel/import-user', formData, headers);
        }
    }
