                ...
                <div class="col-md-12 col-sm-12">
                    <div class="box box-widget">
                        ...
                        <div class="box-footer">
                            <a :href="'/cea-2.0/public/nhap-diem/' + lh_id + '/ket-qua-hoc-tap?semester=' + (sIndex + 1)"
...
const consumer = {
    getDanhSachHocKy: function (lh_id, semester) {
        const url = 'http://localhost/cea-2.0/public/api/nhap-diem/' + lh_id + '/hoc-ky?semester=' + semester;
    ...
    destroyBangDiem: function (bd_id) {
        const url = `http://localhost/cea-2.0/public/api/nhap-diem/${bd_id}/bang-diem`;
        return axios.delete(url);
    },
    destroyBangDiemDotThi: function (dt_bd_id) {
        const url = `http://localhost/cea-2.0/public/api/nhap-diem/${dt_bd_id}/bang-diem-dot-thi`;
        return axios.delete(url);
    },
}
...
export default {
    ...
    filters: {
        ...
        nhapDiemMonHocUrl: function (monHoc) {
            ...
            return 'http://localhost/cea-2.0/public/nhap-diem/mon-hoc/' + baseSixFour;
        },
        nhapDiemDotThiUrl: function (monHoc) {
            ...
            return 'http://localhost/cea-2.0/public/api/nhap-diem/dot-thi/' + baseSixFour;
        },
        nhapDiemRenLuyenUrl: function (semester) {
            let baseSixFour = btoa(JSON.stringify({ lh_id: semester.lh_id, hoc_ky: semester.semester }));
            return 'http://localhost/cea-2.0/public/api/nhap-diem/ren-luyen/' + baseSixFour;
        }
    },
    methods: {
        ...
        shareNotification: function(mh, model) {
            ...
            /* const url = `http://localhost/cea-2.0/public/api/nhap-diem/`;
