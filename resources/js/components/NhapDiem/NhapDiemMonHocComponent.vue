  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div style="margin-bottom: 6px">
        <a :href="'http://localhost/cea-2.0/public/nhap-diem/' + lh_id" class="btn btn-default">
            ...
            <div class="box-body table-responsive">
              ...
              <div style="margin-bottom: 10px">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li>
                      <a href="http://localhost/cea-2.0/public/sample/import-diem-2022-sample.xls"
                        >QC2022 - Mẫu có công thức</a
                      >
                    </li>
                    <li>
                      <a href="http://localhost/cea-2.0/public/sample/import-diem-2022-raw-sample.xls"
                        >QC2022 - Mẫu không có công thức</a
                      >
                    </li>
                    <li>
                      <a href="http://localhost/cea-2.0/public/sample/import-diem-sample.xls"
                        >QC2020 - Mẫu có công thức</a
                      >
                    </li>
                    <li>
                      <a href="http://localhost/cea-2.0/public/sample/import-diem-raw-sample.xls"
...
const consumer = {
  ...
  getBangDiem: function (lh_id, mh_id, hocKy, type) {
    ...
    const url = `http://localhost/cea-2.0/public/api/nhap-diem/${lh_id}/bang-diem?mh_id=${mh_id}&hocky=${hocKy}&bd_type=${type}`;
    return axios.get(url).then((response) => response.data);
  },
