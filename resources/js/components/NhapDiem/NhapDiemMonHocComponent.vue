  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div style="margin-bottom: 6px">
        <a :href="'/cea_3.0/public/nhap-diem/' + lh_id" class="btn btn-default">
...
const consumer = {
  ...
  getBangDiem: function (lh_id, mh_id, hocKy, type) {
    ...
    const url = `http://localhost/cea_3.0/public/api/nhap-diem/${lh_id}/bang-diem?mh_id=${mh_id}&hocky=${hocKy}&bd_type=${type}`;
    return axios.get(url).then((response) => response.data);
  },
  ...
  uploadFile: function (file, quyChe2022, hasCal) {
    ...
    let url = "http://localhost/cea_3.0/public/api/excel/import-raw-score";
    if (hasCal) {
      url = "http://localhost/cea_3.0/public/api/excel/import-score";
    }
