  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div style="margin-bottom: 6px">
        <a :href="'/tthl11/public/nhap-diem/' + lh_id" class="btn btn-default">
...
const consumer = {
  ...
  getDanhSachHocKy: function (kdt_id) {
    const url = "'http://localhost/tthl11/public/api/khoa-dao-tao/" + kdt_id + "/hoc-ky";
    return axios
      .get(url)
  ...
  getBangDiem: function (lh_id, mh_id, hocKy, type) {
    ...
    const url = `http://localhost/tthl11/public/api/nhap-diem/${lh_id}/bang-diem?mh_id=${mh_id}&hocky=${hocKy}&bd_type=${type}`;
    return axios.get(url).then((response) => response.data);
  },
  saveBangDiem: function (formData) {
    const url = `http://localhost/tthl11/public/api/nhap-diem/${formData.lh_id}/bang-diem`;
  ...
  uploadFile: function (file, quyChe2022, hasCal) {
    ...
    let url = "http://localhost/tthl11/public/api/excel/import-raw-score";
    if (hasCal) {
      url = "http://localhost/tthl11/public/api/excel/import-score";
    }
