...
<script>
    const consumer = {
        ...
        getBangDiem: function(lh_id, hocKy) {
            ...
            const url = `http://localhost/tthl/public/api/nhap-diem/${lh_id}/bang-diem?hocky=${hocKy}&bd_type=2`;
            return axios.get(url).then(response => response.data);
        },
        ...
        uploadFile: function (file) {
            ...
            let url = 'http://localhost/tthl/public/api/excel/import-ren-luyen-score';
