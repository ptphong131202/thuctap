...
<script>
    const consumer = {
        ...
        getBangDiem: function(lh_id, hocKy) {
            ...
            const url = `http://localhost/cea-2.0/public/api/nhap-diem/${lh_id}/bang-diem?hocky=${hocKy}&bd_type=2`;
            return axios.get(url).then(response => response.data);
        },
        ...
        uploadFile: function (file) {
            ...
            let url = 'http://localhost/cea-2.0/public/api/excel/import-ren-luyen-score';
