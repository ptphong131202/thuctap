              ...
              <table class="table table-striped table-bordered no-margin">
                <thead>
                  <tr>
                    ...
                    <th class="w-100-p text-center">Kết quả học tập</th>
                    <th class="w-100-p text-center" v-if="quyenNhapDiem">Thêm đợt thi</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(lh, index) in table.list.data" :key="lh.lh_id">
                    ...
                    <td class="text-center" v-if="quyenNhapRenLuyen || quyenNhapDiem">
                      ...
                      >
                        <i class="fa fa-list-ol"></i> Danh sách môn học
                      </a>
                    </td>
...
const consumer = {
  getListLopHoc: function () {
    const url = "http://localhost/tthl11/public/api/nhap-diem" + window.location.search;
  ...
  getListDotThi: function (chuongtrinh) {
    const url = "http://localhost/tthl11/public/api/dot-thi/all?chuongtrinh=" + chuongtrinh;
    return axios.get(url).then((response) => response.data);
  },
  capNhatDotThiChoLop: function (formData) {
    return axios.post("http://localhost/tthl11/public/api/dot-thi/cap-nhat-dot-thi-cho-lop", formData);
  },
};
