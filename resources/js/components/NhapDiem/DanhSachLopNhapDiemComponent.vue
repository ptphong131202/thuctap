...
const consumer = {
  getListLopHoc: function () {
    const url = "http://localhost/cea_3.0/public/api/nhap-diem" + window.location.search;
  ...
  getListDotThi: function (chuongtrinh) {
    const url = "http://localhost/cea_3.0/public/api/dot-thi/all?chuongtrinh=" + chuongtrinh;
    return axios.get(url).then((response) => response.data);
  },
  capNhatDotThiChoLop: function (formData) {
    return axios.post("http://localhost/cea_3.0/public/api/dot-thi/cap-nhat-dot-thi-cho-lop", formData);
  },
};
