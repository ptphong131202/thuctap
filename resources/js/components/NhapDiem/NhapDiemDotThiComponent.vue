...
<script>
    const consumer = {
        ...
        saveBangDiem: function (formData) {
            const url = `http://localhost/cea-2.1/public/api/nhap-diem/${formData.lh_id}/bang-diem-dot-thi`;
        ...
        uploadFile: function (file) {
            ...
            const url = 'http://localhost/cea-2.1/public/apiexcel/import-diemdotthi-theomon';
