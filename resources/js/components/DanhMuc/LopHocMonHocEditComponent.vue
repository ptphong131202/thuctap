...
const consumer = {
    ...
    getDanhSachHocKy: function (lh_id) {
        const url = 'http://localhost/cea_3.0/public/api/lop-hoc/' + lh_id + '/hoc-ky';
        return axios.get(url)
            .then(response => response.data)
            .then(data => {
    ...
    getDanhSachMonHoc: function (kdt_id) {
        // const url = 'http://localhost/cea_3.0/public/api/mon-hoc/all?hdt_id=' + hdt_id + '&nn_id=' + nn_id;
        // return axios.get(url)
        //         .then(response => response.data);
        const url = 'http://localhost/cea_3.0/public/api/mon-hoc/all-by-khoa-dao-tao?kdt_id=' + kdt_id;
        return axios.get(url)
            .then(response => response.data);
    },
