    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a :href="'http://localhost/cea_4.0/public' + parent_url"
                        >Ngành nghề</a
                    >
                </li>
        ...
        <section class="content">
            <div style="margin-bottom: 6px">
                ...
                <a
                    :href="'http://localhost/cea_4.0/public' + parent_url"
...
const consumer = {
    ...
    getDanhSachMonHoc: function (hdt_id, nn_id) {
        const url =
            "http://localhost/cea_4.0/public/api/mon-hoc/all?hdt_id=" +
            hdt_id +
            "&nn_id=" +
            nn_id;
    ...
    getListNganhNghe: function (hdt_id) {
        const url =
            "http://localhost/cea_4.0/public/api/nganh-nghe/all?hedaotao=" +
            hdt_id;
        return axios.get(url).then((response) => response.data);
    },
