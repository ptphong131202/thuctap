    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a :href="'http://localhost/cea-4.0/public' + parent_url"
                        >Ngành nghề</a
                    >
                </li>
        ...
        <section class="content">
            <div style="margin-bottom: 6px">
                ...
                <a
                    :href="'http://localhost/cea-4.0/public' + parent_url"
...
const consumer = {
    ...
    getDanhSachMonHoc: function (hdt_id, nn_id) {
        const url =
            "http://localhost/cea-4.0/public/api/mon-hoc/all?hdt_id=" +
            hdt_id +
            "&nn_id=" +
            nn_id;
    ...
    getListNganhNghe: function (hdt_id) {
        const url =
            "http://localhost/cea-4.0/public/api/nganh-nghe/all?hedaotao=" +
            hdt_id;
        return axios.get(url).then((response) => response.data);
    },
    save: function (formData) {
        if (formData.mh_id == null) {
            return axios.post(
                "http://localhost/cea-4.0/public/api/mon-hoc",
                formData
            );
        } else {
            return axios.put(
                "http://localhost/cea-4.0/public/api/mon-hoc/" + formData.mh_id,
                formData
            );
        }
    },
    destroy: function (mh_id) {
        return axios.delete(
            "http://localhost/cea-4.0/public/api/mon-hoc/" + mh_id
        );
    },
    restore: function (mh_id) {
        return axios.put(
            "http://localhost/cea-4.0/public/api/mon-hoc/restore/" + mh_id
        );
    },
};
